...
#     """
#     Validate that the total quantity received against each Purchase Order Item
...
#             frappe.throw(
#                 _("Row for Item {0} is missing Purchase Order or Purchase Order Item.")
#                 .format(item_code)
#             )
...
# ############### gmp.gmp_machine.doc_event.grn_po_validate.validate_grn_quantities
