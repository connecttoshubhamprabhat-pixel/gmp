...
# def get_payment_entry_allocated_total(reference_names):
#     """Sum allocated_amount from submitted Payment Entry references
#     against the given Purchase Order / Purchase Invoice names."""
...
# def get_unreconciled_allocated_total(reference_names):
#     """Sum allocated_amount from submitted, not-unlinked Unreconcile Payment
#     Entries against the given Purchase Order / Purchase Invoice names."""
#     if not reference_names:
#         return 0
...
#     after netting off amounts already paid/allocated via Payment Entries
#     and Unreconcile Payment records."""
...
#     paid_via_payment_entry = get_payment_entry_allocated_total(all_reference_names)
#     paid_via_unreconcile = get_unreconciled_allocated_total(all_reference_names)
#     total_paid = paid_via_payment_entry + paid_via_unreconcile
